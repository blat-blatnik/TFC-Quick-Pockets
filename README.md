...
**Note** This mod manipulates your inventory. This can sometimes result in items being lost, or duplicated in case of more severe bugs. Even though it was tested somewhat thoroughly by this point some problems may still have slipped through the cracks. Only use this if you understand the risks. _**Back up** your beloved save games before using this mod_.
